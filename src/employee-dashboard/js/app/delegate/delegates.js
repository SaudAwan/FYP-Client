...
import {getEventDelegates, getEventDelegatesCount, removeDelegate} from '../api'
...
export default class Delegate extends React.Component {
    ...
    fetchDelegatesCount = (payload) => {
        ...
        return getEventDelegatesCount(query)
        .then(resp => {
            return resp.json();
        })
    }
    ...
    fetchDelegates = (payload) => {
        ...
        return getEventDelegates(query)
        .then(resp => {
            return resp.json();
        })
    }
