...
import {getEventInventoryCount, getEventInventory, removeInventory} from '../../api'
...
export default class Inventory extends React.Component {
    ...
    fetchInventoryCount = (payload) => {
        ...
        return getEventInventoryCount(query)
        .then(resp => {
            return resp.json();
        })
    }
    ...
    fetchInventory = (payload) => {
        ...
        return getEventInventory(query)
        .then(resp => {
            return resp.json();
        })
    }
