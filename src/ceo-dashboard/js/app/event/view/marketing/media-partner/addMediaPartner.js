    ...
    addMediaPartner(e) {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                this.props.addMediaPartner(values);
                setTimeout(() => {
...
export default class AddMediaPartner extends React.Component {
    ...
    handleSearch(value) {
        return eventApi.getMediaPartners('?searchText=' + value).then(resp => {
            return resp.json();
        }).then(mediaPartners => {
    ...
    addMediaPartner(values) {
        var status;
        eventApi.addMediaPartner(values).then(resp => {
            status = resp.status;
            return resp.json();
        }).then(resp => {
            this.onSelect(resp)
