...
export default class Sponsor extends React.Component {
    ...
    fetchSponsorsCount = (payload) => {
        ...
        return eventApi.getEventSponsorsCount(query)
        .then(async(resp) => {
            return resp
        })
    }
    ...
    fetchSponsors = (payload) => {
        ...
        return eventApi.getEventSponsors(query)
        .then(resp => {
            return resp.json();
        })
    }
    ...
    removeSponsor = (id) => {
        ...
        eventApi.removeSponsor(id).then(data => {
            this.fetchSponsors();
    ...
    render() {
        ...
        return (
            <div style={{height: '100%'}}>
                {/* <div style={{position: 'absolute', top: '24px', right: '24px', display: 'inline-block', zIndex: '10'}}>
